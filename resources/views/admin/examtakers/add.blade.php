<form method="POST" id="examtakers-add-form" class="form-horizontal form-bordered smart-form" action="javascript:;" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" id="family_name" class="base-input" name="family_name" placeholder="{{trans('display.family_name')}}"  data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
  </div>
  <div class="form-group">

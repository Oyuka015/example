<form method="POST" id="faq-edit-form" class="form-horizontal form-bordered smart-form" action="javascript:;" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="number" id="code" class="base-input" value="{{$userRole->code}}" name="code" placeholder="{{trans('display.code')}}"  data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
  </div>
  <div class="form-group">
    <label for="name">{{trans('display.name')}}</label>
    <input type="text" id="name" class="base-input" name="name" value="{{$userRole->name}}" placeholder="{{trans('display.name')}}"  data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
  </div>

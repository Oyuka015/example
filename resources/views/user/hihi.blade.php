...
<div class="user-profile-section">
    <div class="user-profile-sidebar" style="background-color:#e3e2e2">
    ...
    <div class="user-profile-main" style="background-color:orange; padding:30px;">
        <div class="first">
            ...
            <div class="user-profile-info">
                ...
                <div style="display:flex; flex-wrap:wrap; gap:20px;">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{$userData->province}}" readonly>
                    </div>
                    <div>

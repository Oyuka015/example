...
class FaqController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        {
            $app = $this->faq->create($request->input());
            $response = array(
                'status' => 'success',
    ...
    public function update($id, Request $request)
    {
        ...
        {
            $app = $this->faq->update($id, $request->input());
            $response = array(
                'status' => 'success',
                'msg' => trans('messages.success_save'),
            );
    ...
    {
        return $this->faq->getDatatableList($request);
    }

    public function destroy($id)
    {
        $app = $this->faq->delete($id);
        $response = array(
            'status' => 'success',
